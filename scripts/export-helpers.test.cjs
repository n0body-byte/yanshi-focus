...
test("专注明细 CSV 带 UTF-8 BOM 并保留筛选顺序", () => {
  const csv = buildSessionCsv([
    ...
    { taskTitle: "英语,阅读", source: "manual", startedAt: "2026-08-09T01:00:00.000Z", endedAt: "2026-08-09T01:10:00.000Z", durationSeconds: 600, completed: false }
  ]);
