...
test("专注明细 CSV 带 UTF-8 BOM 并保留筛选顺序", () => {
  const csv = buildSessionCsv([
    { taskTitle: "数学真题", startedAt: "2026-08-10T01:00:00.000Z", endedAt: "2026-08-10T01:25:00.000Z", durationSeconds: 1500, completed: true },
  ...
  assert.match(csv, /^\uFEFF任务,开始时间,结束时间,专注分钟,完成方式\r\n/);
